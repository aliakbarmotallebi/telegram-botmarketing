...
class shopbot extends drupalRest{
  ...
  public $Token='394484094:AAHjUUllO3zntT6M3IeFAexRjMRCuSB1rf4';
  public $ChatId;
  public $TEXT;
  public $URl = "http://botmarketing.ir/?q=bot/";
...
private function inline_query(){
       if($this->queryText !==''){
        ...
        $in = array();
                ...
                $jjjjjjj = array('inline_keyboard'=>array(array(array('text'=>"سفارش میدم!",'url'=>"https://telegram.me/servatservatbot?start=NODE_".$this->queryText))));
          $entry = array(
              "type" => "article", 
              "id" => $code, 
              "title" => $view['title'], 
