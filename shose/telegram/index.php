...
class shopbot extends drupalRest{
  ...
  public $Token='444279917:AAEAd6xv7DmHcWc55Vt_cAUwuy5fo3C3wb4';
  public $ChatId;
  public $TEXT;
...
private function inline_query(){
       if($this->queryText !==''){
        ...
        $in = array();
                ...
                $jjjjjjj = array('inline_keyboard'=>array(array(array('text'=>"سفارش میدم!",'url'=>"https://telegram.me/ShoeShoebot?start=NODE_".$this->queryText))));
          $entry = array(
              "type" => "article", 
              "id" => $code, 
              "title" => $view['title'], 
