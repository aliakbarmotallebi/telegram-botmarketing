...
class shopbot extends drupalRest{
  ...
  public $Token='382768100:AAGVYi7YXVSaq_CRMmjURVPU1tsY75VRsIM';
  public $ChatId;
  public $TEXT;
...
private function inline_query(){
       if($this->queryText !==''){
        ...
        $in = array();
                ...
                $jjjjjjj = array('inline_keyboard'=>array(array(array('text'=>"سفارش میدم!",'url'=>"https://telegram.me/shertzirbot?start=NODE_".$this->queryText))));
          $entry = array(
              "type" => "article", 
              "id" => $code, 
              "title" => $view['title'], 
