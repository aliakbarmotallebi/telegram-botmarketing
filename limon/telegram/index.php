...
class shopbot extends drupalRest{
  ...
  public $Token='420217799:AAE1xEt_ojAL5ZBf6VSZUOKN3S77iGf1r-0';
  public $ChatId;
  public $TEXT;
...
private function inline_query(){
       if($this->queryText !==''){
        ...
        $in = array();
                ...
                $jjjjjjj = array('inline_keyboard'=>array(array(array('text'=>"سفارش میدم!",'url'=>"https://telegram.me/limonlimonbot?start=NODE_".$this->queryText))));
          $entry = array(
              "type" => "article", 
              "id" => $code, 
              "title" => $view['title'], 
