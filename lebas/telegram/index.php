...
class shopbot extends drupalRest{
  ...
  public $Token='441812885:AAFB-ai2Sz9KUAMvholYq6OWSyQ-y0Nyo00';
  public $ChatId;
  public $TEXT;
 ...
 if($this->queryText !==''){
  if(is_numeric($this->queryText)){
   ...
   if($view){
    ...
    $jjjjjjj = array('inline_keyboard'=>array(array(array('text'=>"سفارش میدم!",'url'=>"https://telegram.me/foroshgalLebasBot?start=NODE_".$this->queryText))));
    $entry = array(
      "type" => "article", 
      "id" => $code, 
      "title" => $view['title'], 
