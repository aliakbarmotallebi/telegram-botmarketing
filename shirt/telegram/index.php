...
class shopbot extends drupalRest{
  ...
  public $Token='354123779:AAFDpv99sdQeGIB4oZx4hXeFesJrbfsG0hg';
  public $ChatId;
  public $TEXT;
...
private function inline_query(){
       if($this->queryText !==''){
        ...
        $in = array();
                ...
                $jjjjjjj = array('inline_keyboard'=>array(array(array('text'=>"سفارش میدم!",'url'=>"https://telegram.me/arasjamebot?start=NODE_".$this->queryText))));
          $entry = array(
              "type" => "article", 
              "id" => $code, 
              "title" => $view['title'], 
